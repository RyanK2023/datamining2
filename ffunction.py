...
def df_add_stats(df_table):
    ...
    #totalcount = df_table.shape[0]
    #ccount = df_c.shape[0]
    #nccount = df_nc.shape[0]

    #print(totalcount)
    #print(ccount)
    #print(nccount)

    #ncprop = nccount / totalcount
    #cprop = ccount / totalcount
...
df_t1_sorted = df_add_stats(df_training1)
df_t2_sorted = df_add_stats(df_training2)
df_t3_sorted = df_add_stats(df_training3)




df_t1_sorted.sort_values('F(s, t)', ascending = False, inplace = True)

#print(df_t2_sorted.sort_values('F(s, t)', ascending = False).head(10))
#print(df_t3_sorted.sort_values('F(s, t)', ascending = False).head(10))

#print(df_t1_sorted.sort_values('F(s, t)', ascending = True).head(10))
#print(df_t2_sorted.sort_values('F(s, t)', ascending = True).head(10))
#print(df_t3_sorted.sort_values('F(s, t)', ascending = True).head(10))

df_t1_sorted.reset_index(inplace = True, drop = True)
df_t2_sorted.reset_index(inplace = True, drop = True)
df_t3_sorted.reset_index(inplace = True, drop = True)

df_t1_sorted.head(10)

head1 = df_t1_sorted['Mutation List'][0]
#head2 = df_t2_sorted['Mutation List'][0]
#head3 = df_t3_sorted['Mutation List'][0]
